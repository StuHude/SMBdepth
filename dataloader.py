...
class DataLoadPreprocess(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            ...
            if self.mode == 'online_eval':
                sample = {'image': image,"image_show":image, 'depth': depth_gt, 'focal': focal, 'has_valid_depth': has_valid_depth,
...
class ToTensor(object):
    ...
    def __call__(self, sample):
        ...
        imageshow = sample['image_show']
        imageshow = self.to_tensor(imageshow)
        ...
        if self.mode == 'train':
            ...
            return {'image': image,"image_show":imageshow, 'depth': depth, 'focal': focal, 'has_valid_depth': has_valid_depth,
